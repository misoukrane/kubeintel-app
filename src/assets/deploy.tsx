export const DeployLogo = (props: any) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M10.225 13.732a4.446 4.446 0 1 1 4.227-4.728l-1.757.113a2.685 2.685 0 1 0-2.553 2.856z"
      style={{
        fill: '#fff',
        fillRule: 'evenodd',
        stroke: 'none',
      ...
      transform="translate(-1.646 -.54)"
    />
    <path
      d="m11.136 9.009 1.397 3.42 3.226-3.42z"
      style={{
        fill: '#fff',
        fillRule: 'evenodd',
        stroke: 'none',
