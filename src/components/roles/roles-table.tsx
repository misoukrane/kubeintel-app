...
interface RolesTableProps {
  ...
  navigateToRole?: (namespace: string, name: string) => void;
...
export const RolesTable = ({
  ...
  // Create unique label options from all roles
  ...
  const columns: ColumnDef<V1Role>[] = [
    {
      id: 'name',
        ...
        return (
          <div className="flex items-center">
            <Button
              ...
              className="underline"
              onClick={() =>
                navigateToRole ? navigateToRole(namespace, name) : null
              }
            >
              {name}
            </Button>
